...
from shop.utils.argparse import clear_environ, positive_int
from shop.utils.pg import DEFAULT_PG_URL


ENV_VAR_PREFIX = 'SHOP_'
...
group.add_argument('--api-port', type=positive_int, default=80,
